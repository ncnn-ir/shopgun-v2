...
class CertRenderer
{
    ...
    public static function renderBatchHtml(array $certs, int $cols = 3): string
    {
        ...
        return '<!DOCTYPE html><html lang="fa" dir="rtl"><head><meta charset="UTF-8">'
            ...
            . '.batch-card{flex:0 0 auto;page-break-inside:avoid;break-inside:avoid;margin:0}.batch-card .certificate{box-shadow:none!important;transform:none!important;margin:0!important}'
            . '</style>'
