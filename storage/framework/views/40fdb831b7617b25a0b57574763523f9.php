<?php $__bladeCompiler = app('blade.compiler'); ?><div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($show && $certificate): ?>
        ...
        <div class="relative bg-base-100 rounded-2xl shadow-2xl w-full max-w-3xl my-8 md:my-16 border border-base-300">
            ...
            <div class="flex items-center justify-between p-4 border-b border-base-300 bg-gradient-to-l from-cyan-500/10 to-transparent rounded-t-2xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="font-bold text-base">شناسنامه #<?php echo e($__bladeCompiler->applyEchoHandler($certificate->code)); ?></h2>
                        <div class="text-xs text-base-content/60 font-mono" dir="ltr"><?php echo e($__bladeCompiler->applyEchoHandler($certificate->serial)); ?></div>
                    </div>
                </div>
            ...
            <div class="p-5 space-y-4 max-h-[calc(100vh-14rem)] overflow-y-auto">
                ...
                <div class="flex justify-center bg-base-200/50 rounded-lg p-4">
                    <div id="viewModalScaleWrap" style="transform-origin: top center;">
                        <div class="cert-modal-display">
                            <?php echo $__bladeCompiler->applyEchoHandler($cardHtml); ?>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                    <div class="p-3 rounded-lg bg-base-200/50">
                        ...
                        <div class="font-bold mt-0.5"><?php echo e($__bladeCompiler->applyEchoHandler($certificate->stone_name)); ?></div>
                    </div>
                    <div class="p-3 rounded-lg bg-base-200/50">
                        <div class="text-[10px] text-base-content/60">⚙️ فلز</div>
                        <div class="mt-0.5"><?php echo e($__bladeCompiler->applyEchoHandler($certificate->metal)); ?> (<?php echo e($__bladeCompiler->applyEchoHandler($certificate->metal_carat)); ?>)</div>
                    </div>
                    <div class="p-3 rounded-lg bg-base-200/50">
                        <div class="text-[10px] text-base-content/60">📐 ابعاد</div>
                        <div class="mt-0.5"><?php echo e($__bladeCompiler->applyEchoHandler($certificate->dimension)); ?> mm</div>
                    </div>
                    <div class="p-3 rounded-lg bg-base-200/50">
                        <div class="text-[10px] text-base-content/60">⚖️ وزن</div>
                        <div class="mt-0.5"><?php echo e($__bladeCompiler->applyEchoHandler($certificate->weight_clean)); ?> gr</div>
                    </div>
                    <div class="p-3 rounded-lg bg-base-200/50">
                        <div class="text-[10px] text-base-content/60">👤 مشتری</div>
                        <div class="mt-0.5"><?php echo e($__bladeCompiler->applyEchoHandler($certificate->customer?->name ?? '—')); ?></div>
                    </div>
                    <div class="p-3 rounded-lg bg-base-200/50">
                        <div class="text-[10px] text-base-content/60">📅 صدور</div>
                        <div class="mt-0.5 text-xs"><?php echo e($__bladeCompiler->applyEchoHandler(\App\Support\PersianDate::format($certificate->issued_at ?? now(), 'Y/m/d'))); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 border-t border-base-300 flex flex-wrap justify-end gap-2 rounded-b-2xl bg-base-200/50">
                ...
                <a href="<?php echo e($__bladeCompiler->applyEchoHandler(route('certificates.show', $certificate))); ?>" class="btn btn-outline btn-sm">صفحه کامل</a>
            </div>
        </div>
    </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($show && $certificate): ?>
<script type="text/template" id="cert-modal-batch-template"><?php echo $__bladeCompiler->applyEchoHandler($batchHtml); ?></script>
    ...
    window.exportCertModalPng = function () {
        ...
        setTimeout(function () {
            html2canvas(clone, {
                ...
                a.download = 'certificate-<?php echo e($__bladeCompiler->applyEchoHandler($certificate->code ?? "cert")); ?>.png';
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH /data/data/com.termux/files/home/shopgun-v2.2/resources/views/livewire/certificates/view-modal.blade.php ENDPATH**/ ?>