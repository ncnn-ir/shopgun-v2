...
# -*- coding: utf-8 -*-
"""
ShopGun V2 - Core Refactor Phase 6
====================================
- Settings با ناوبری دو سطحی (4 گروه + زیر-تب)
- گروه System: General, Appearance, Notifications, Maintenance
- گروه Commerce: WooCommerce, Sync, API Monitor
- گروه Certificates: Templates, Sizes, Stones/Metals, Labels, Assets
- گروه Catalog: Woo Categories, Attributes, Terms, Users
"""
...
# ═══════════════════════════════════════════════════════════════
# 1. Settings Index — بازنویسی کامل با ناوبری دو سطحی
# ═══════════════════════════════════════════════════════════════

write('app/Livewire/Settings/Index.php', r'''<?php
...
# ═══════════════════════════════════════════════════════════════
# 2. Settings View — بازنویسی کامل با ناوبری دو سطحی
# ═══════════════════════════════════════════════════════════════

SETTINGS_VIEW = r'''<div style="padding:14px 14px 20px;direction:rtl">
...
print("=" * 60)
print()
print("🎯 دستاوردهای فاز ۶:")
print("   ✅ Settings با ناوبری دو سطحی")
print("   ✅ ۴ گروه: System / Commerce / Certificates / Health")
print("   ✅ System: General, Appearance, Notifications, Maintenance")
print("   ✅ Commerce: Woo, Sync, API Monitor")
print("   ✅ Certificates: Templates, Sizes, Catalog, Labels, Assets")
print("   ✅ Health: Health, Logs, Backup")
print()
